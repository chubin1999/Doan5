...
import { DondathangService } from '../../shared/services/dondathang.service';
...
export class DondathangComponent implements OnInit {
  ...
  public entity: any;
  public Id: any;
  constructor(private dondathangService: DondathangService) {}
  ...
  getSingled(id: string){
      this.dondathangService.getItem(id).subscribe(res=>{
          this.entity = res;
      });
  }
  ...
  loadData() {
      this.dondathangService.getLink().subscribe((res: any) => {
  ...
  onClick(value: any) {
      ...
      if (this.Id == 0) {
          this.dondathangService.postItem(value).subscribe((res) => {
          ...
          console.log(value);
          this.dondathangService.editItem(value.mahang, value).subscribe(res => {
  ...
  onDelete(id: string) {
      ...
      if (confirmResult) {
          this.dondathangService.deleteItem(id).subscribe((response) => {
              if (response) {
