...
export class LoaisanphamService {
    ...
    postItem(data: any): Observable<any> {
        return this._http.post<any>(this.urlAPI, data).pipe(
            map((res) => {
                return res;
            })
        );
    ...
    editItem(id: any, data: any): Observable<any> {
        return this._http.put<any>(this.urlAPI + '/' + id, data, HeadersOptions).pipe(
            map((res) => {
                return res;
            })
        );
    ...
    deleteItem(id: string): Observable<any> {
        debugger;
        return this._http.delete<any>(this.urlAPI + '/' + id).pipe(
            map((res) => {
                return res;
            })
        );
